{ pkgs, config, ... }:
{
  services.caddy = {
    ...
    package = (pkgs.callPackage "${builtins.fetchurl { url = "https://raw.githubusercontent.com/jpds/nixpkgs/a33b02fa9d664f31dadc8a874eb1a5dbaa9f4ecf/pkgs/servers/caddy/default.nix"; sha256 = "ae6cc6fd66edd13e6517b684960bbfa4f711b396aedac2bc149fb20a3d362ff4"; }}" {
      externalPlugins = [
