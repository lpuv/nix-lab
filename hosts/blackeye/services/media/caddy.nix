{ pkgs, config, ... }:
{
  services.caddy = {
    ...
    package = (pkgs.callPackage "${builtins.fetchurl { url = "https://raw.githubusercontent.com/jpds/nixpkgs/a33b02fa9d664f31dadc8a874eb1a5dbaa9f4ecf/pkgs/servers/caddy/default.nix"; sha256 = "sha256-C7JOGd4sXsRZL561oP84V2/pTg7szEgF4OFOw35yS1s="; }}" {
      externalPlugins = [
